...
const NotFound = () => {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center text-center px-4 py-12">
      ...
      <h1 className="text-6xl font-black text-text-main tracking-tight">404</h1>
      <h2 className="text-xl font-bold text-text-main mt-2 mb-4">Page Not Found</h2>
      ...
      <Link
        to="/"
        className="flex items-center gap-2 px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-text-main font-semibold text-sm transition-colors shadow-lg shadow-blue-600/10"
      >
