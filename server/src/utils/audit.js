...
export const AUDIT_ACTIONS = {
  ...
  BULK_FACULTY_IMPORT: 'BULK_FACULTY_IMPORT',
  BULK_MARK_IMPORT: 'BULK_MARK_IMPORT',
  BULK_TIMETABLE_IMPORT: 'BULK_TIMETABLE_IMPORT',
  ATTENDANCE_EXPORTED: 'ATTENDANCE_EXPORTED',
  MARKS_EXPORTED: 'MARKS_EXPORTED',
  TIMETABLE_EXPORTED: 'TIMETABLE_EXPORTED',
  RISK_LEVEL_CHANGED: 'RISK_LEVEL_CHANGED',
  RISK_RECALCULATION_TRIGGERED: 'RISK_RECALCULATION_TRIGGERED',
  ...
  PLACEMENT_PROFILE_UPDATED: 'PLACEMENT_PROFILE_UPDATED',
  PLACEMENT_RESUME_UPLOADED: 'PLACEMENT_RESUME_UPLOADED',
  STUDENT_ELIGIBILITY_UPDATED: 'STUDENT_ELIGIBILITY_UPDATED',
  ...
  BULK_PLACEMENT_PROFILE_IMPORT: 'BULK_PLACEMENT_PROFILE_IMPORT',
  BULK_COMPANY_IMPORT: 'BULK_COMPANY_IMPORT',
  BULK_OFFER_IMPORT: 'BULK_OFFER_IMPORT',
  PLACEMENT_APPLICATIONS_EXPORTED: 'PLACEMENT_APPLICATIONS_EXPORTED',
  PLACEMENT_OFFERS_EXPORTED: 'PLACEMENT_OFFERS_EXPORTED',
  PLACEMENT_ROSTER_EXPORTED: 'PLACEMENT_ROSTER_EXPORTED'
};
